                ...
                <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        ...
                        <li class="m-portlet__nav-item">
                            <a href="{{ url('new-vehicle') }}" class="btn btn-primary m-btn  m-btn--custom m-btn--icon m-btn--air">
                                <span>
                                    <i class="fa fa-car"></i>
                ...
                <table class="table table-bordered table-striped " id="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('show-vehicle/'.$vehicle->id) }}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="View ">
                                    <i class="fa fa-eye"></i>
                                </a>
                        ...
                        <tr>
                            ...
                            <td data-field="Status" class="m-datatable__cell"><span style="width: 110px;"><span class="m-badge  m-badge--warning m-badge--wide">{{ "In Garage" }}</span></span></td>
