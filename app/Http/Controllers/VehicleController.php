    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if (Auth::user()->role == 'dev' || Auth::user()->role == 'admin') {
                ...
                $vehicle->save();
                request()->session()->flash('success', 'Vehicle Registered Successfully');
            } else {
                request()->session()->flash('error', 'You are not authorized to perform this action');
            }
        }
